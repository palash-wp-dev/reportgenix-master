...
class Xgenious_Landing_SMS_Gateway_Area_One_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'xgenious-landing-sms-gateway-area-one-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Landing SMS Gateway One', 'xgenous-master' );
	}
	...
	protected function render() {
		...
		?>
        <section class="sms-area padding-top-60 padding-bottom-60" id="smsGateway">-->
                    ...
                    <div class="sms-wrapper">
                        <div class="sms-wrapper-item">
	                        ...
	                        foreach ($faq_list as $list):
		                        ...
		                        printf(' <div class="sms-wrapper-item-single"><a href="%1$s" target="%2$s" > <img src="%3$s" alt="%4$s"></a></div>',$list['button_link']['url'],$list['button_link']['is_external'] ? '_blank' : '_self',$image_src,$image_alt);
	                        endforeach;?>
                        </div>
                    </div>
                </div>
...
Plugin::instance()->widgets_manager->register( new Xgenious_Landing_SMS_Gateway_Area_One_Widget() );