...
class Xgenious_Nazmart_Mini_Price_Plan_Area_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'xgenious-nazmart-mini-price-plan-grid-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Mini Price Plan', 'xgenious-master' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control('title',[
			...
			'label_block' => true,
			'default' => 'Premium Plugins as per your need'
		]);
		$this->add_control(
			'margin__bottom',
			[
            ...
            <div class="container container__one">
                ...
                foreach ($faq_list as $list):
                    ...
                    <div class="col-lg-4 col-md-6 wow animate__ animate__zoomIn animated" data-wow-delay=".1s" >
                        <div class="price_plan_item__xilancer nazmart <?php echo $list['featured'] === 'yes' ? 'featured' : ''; ?>" >
                            <div class="xp_header">
                                <div class="badge-wrap">
                                    <span class="badge"><?php echo esc_html($list['badge']);?></span>
                                </div>
                                <div class="mini_price_plan_header">
                                    <div>
	                                    <?php
...
Plugin::instance()->widgets_manager->register( new Xgenious_Nazmart_Mini_Price_Plan_Area_Widget() );