...
class Xgenious_Landing_Card_Area_Three_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'xgenious-landing-card-area-three-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Landing Card Area Three', 'xgenous-master' );
	}
                ...
                <div class="row g-4 mt-4">
	                ...
	                foreach ($faq_list as $list): ?>
                        <div class="<?php echo esc_attr($settings['column_select']);?>">
                            <figure class="singleGallery-xgenious ">
                                <a href="<?php echo esc_url($list['link']['url'] ?? '')?>" target="_blank">
                                    ...
                                    <figcaption class="caption">
                                        <div>
                                            <h4 class="title"><?php echo esc_html($list['title']);?></h4>
                                            <div class="pera"><?php echo wp_kses_post($list['description']);?></div>
                                        </div>
                                    </figcaption>
                                </a>
                            </figure>
...
Plugin::instance()->widgets_manager->register( new Xgenious_Landing_Card_Area_Three_Widget() );