...
class Xgenious_Landing_Card_Area_One_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'xgenious-landing-card-area-one-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Landing Card One', 'xgenous-master' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control( 'direction', [
			...
			'label'   => esc_html__( 'Change Direction', 'xgenious-master' ),
		] );
	...
	protected function render() {
		...
		?>
        <section class="demo-area padding-top-60 padding-bottom-60">
            <div class="container container_1430">
                <div class="support-area-wrapper support-wrapper-padding section-bg-2 radius-10">
                    <div class="row g-5 align-items-center justify-content-between <?php echo $settings['direction'] === 'yes' ? 'flex-row-reverse' : '';?>">
                        <div class="col-lg-6">
                            <div class="support-wrapper-image demo-style">
                        ...
                        <div class="col-lg-6">
                            <div class="support-wrapper">
                                <div class="support-wrapper-contents">
                                    ...
                                    <p class="support-wrapper-contents-para mt-3"> <?php echo esc_html($settings['description']);?> </p>
...
Plugin::instance()->widgets_manager->register( new Xgenious_Landing_Card_Area_One_Widget() );