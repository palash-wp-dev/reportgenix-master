...
class Xgenious_Topbar_Offer_One_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'xgenious-topbar-offer-one-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Topbar Offer: 01', 'xgenous-master' );
	}
	...
	protected function render() {
		...
		?>
		<div class="notification_bar_top topbar_area topbar_area__padding bg-main">
...
Plugin::instance()->widgets_manager->register( new Xgenious_Topbar_Offer_One_Widget() );