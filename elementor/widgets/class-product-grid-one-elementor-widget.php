...
namespace Elementor;
class Xgenious_Product_Grid_One_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'xgenious-product-grid-one-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Product Post Grid', 'xgenious-master' );
	}
...
Plugin::instance()->widgets_manager->register( new Xgenious_Product_Grid_One_Widget() );
