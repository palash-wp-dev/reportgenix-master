...
class Xgenious_Landing_Client_Area_One_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'xgenious-landing-client-area-one-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Landing Client Area One', 'xgenous-master' );
	}
	...
	protected function render() {
		...
		?>
		<section class="client-area padding-top-60 padding-bottom-60">
					...
					<div class="support-area-wrapper support-wrapper-padding section-bg-2 radius-10">
						<div class="row g-5 align-items-center justify-content-between <?php echo ($settings['row_reverse'] === 'yes') ? 'flex-row-reverse' : '';?> " >
							<div class="col-lg-6 col-xl-5">
								<div class="support-wrapper-image client-review-style">
...
Plugin::instance()->widgets_manager->register( new Xgenious_Landing_Client_Area_One_Widget() );